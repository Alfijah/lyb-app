...
export default function Benefits() {
    ...
    return (
        <section
            id="menu"
            className="relative w-full h-full flex flex-col items-center pb-8 pt-28 md:pt-36 bg-neutral-50"
        >
            <img src={fruitrow}
                loading="lazy"
                alt="papaja in boom"
            ...
            <div className="pt-10 px-6 md:px-8">
                <h2 className="max-w-screen-lg text-md">Benefits</h2>

                <div className="mx-auto pt-8 flex flex-col gap-12 xl:w-[90%]">
